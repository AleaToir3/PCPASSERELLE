...
*
*/
// chagement du randomizer
require_once "lib/randomizer.php";
...
// CRÉATIONS DES INSTANCES DES DEUX COMBATTANTS
// ON UTILISER LA FONCTION getRandomFighter() CONTENUE DANS LE FICHIER "randomizer.php"
$fighter1 = getRandomFighter();
