...
link.moveRight = function (){
    ...
    this.isWalking = true;
    if(this.x + this.deltaMove < document.body.clientWidth - 65)
        this.x += this.deltaMove;    
}
...
link.moveDown = function (){
    this.direction = "down";
    this.isWalking = true;  
    if(this.y + this.deltaMove < document.body.clientHeight - 65 )
        this.y += this.deltaMove;
}
